...
import static com.yfeng.payutil.paypwd.view.DrawHelperUtils.drawPartCircle;


/**
 * Package Name: com.yfeng.payutil.paypwd.view
 *
 * @author ysr
 * @Email yfeng1023@gmail.com
 * @Description: 滑动验证码的View
...
/*        mMaskShadowPaint.setStrokeWidth(50);
    ...
    private void createCaptchaPath() {
        ...
        //随机生成验证码阴影左上角 x y 点，
        mCaptchaX = mRandom.nextInt((int) (mWidth - mCaptchaWidth - gap));
        mCaptchaY = mRandom.nextInt((int)( mHeight - mCaptchaHeight - gap));
